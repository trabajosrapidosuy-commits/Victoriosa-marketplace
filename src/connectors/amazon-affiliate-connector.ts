...
export const amazonAffiliateConnector: SupplierConnector = {
  name: "Amazon Affiliate Connector",
  sourceType: "amazon",
  capabilities: { api: false, csv: true, manualUrl: true, affiliate: true, directDropship: false, requiresCredentials: true },
  ...
  estimateShipping() {
    return { minDays: 5, maxDays: 20, notes: "Estimated only. Confirm with supplier before publishing." };
  },
