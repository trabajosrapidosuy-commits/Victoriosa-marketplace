...
export const aliexpressManualConnector: SupplierConnector = {
  name: "AliExpress Manual Connector",
  sourceType: "aliexpress",
  capabilities: { api: false, csv: true, manualUrl: true, affiliate: false, directDropship: true, requiresCredentials: false },
  ...
  estimateShipping() {
    return { minDays: 15, maxDays: 45, notes: "Estimated only. Confirm with supplier before publishing." };
  },
