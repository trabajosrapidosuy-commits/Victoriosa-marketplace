...
export const dropshipmanConnector: SupplierConnector = {
  name: "Dropshipman Manual Connector",
  sourceType: "dropshipman",
  capabilities: { api: false, csv: true, manualUrl: true, affiliate: false, directDropship: true, requiresCredentials: true },
  ...
  estimateShipping() {
    return { minDays: 12, maxDays: 35, notes: "Estimated only. Confirm with supplier before publishing." };
  },
