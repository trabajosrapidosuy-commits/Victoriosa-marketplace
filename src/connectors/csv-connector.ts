...
export const csvConnector: SupplierConnector = {
  name: "CSV Connector",
  sourceType: "csv",
  capabilities: { api: false, csv: true, manualUrl: false, affiliate: false, directDropship: true, requiresCredentials: false },
  ...
  estimateShipping() {
    return { minDays: 1, maxDays: 45, notes: "Estimated only. Confirm with supplier before publishing." };
  },
