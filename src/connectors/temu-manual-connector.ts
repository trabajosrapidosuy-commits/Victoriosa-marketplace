...
export const temuManualConnector: SupplierConnector = {
  name: "Temu Manual Connector",
  sourceType: "temu",
  capabilities: { api: false, csv: true, manualUrl: true, affiliate: false, directDropship: false, requiresCredentials: false },
  ...
  estimateShipping() {
    return { minDays: 12, maxDays: 45, notes: "Estimated only. Confirm with supplier before publishing." };
  },
